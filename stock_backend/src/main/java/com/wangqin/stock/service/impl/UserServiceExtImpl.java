...
import com.wangqin.stock.exception.BusinessException;
import com.wangqin.stock.mapper.SysRoleMapper;
import com.wangqin.stock.mapper.SysUserMapperExt;
import com.wangqin.stock.mapper.SysUserRoleMapper;
...
import com.wangqin.stock.service.PermissionService;
import com.wangqin.stock.service.UserServiceExt;
...
//        respVo.setNickName(info.getNickName());
     ...
     */
    @Override
    public R<PageResult<UserQueryDomain>> pageUsers(UserPageReqVo vo) {
        //组装分页数据
